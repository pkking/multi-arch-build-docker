...
RUN if [ $TARGETARCH == "amd64" ] && curl -o mf.whl -L https://sglang-ascend.obs.cn-east-3.myhuaweicloud.com/sglang/mf_adapter-1.0.0-cp311-cp311-linux_x86_64.whl
RUN if [ $TARGETARCH == "amd64" ] && curl -o pta.whl -L https://gitcode.com/Ascend/pytorch/releases/download/v7.1.0.2-pytorch2.6.0/torch_npu-2.6.0.post2-cp311-cp311-manylinux_2_17_x86_64.manylinux2014_x86_64.whl
RUN if [ $TARGETARCH == "amd64" ] && curl -o triton.whl -L https://sglang-ascend.obs.cn-east-3.myhuaweicloud.com/sglang/triton_ascend-3.2.0.dev20250815-cp311-cp311-manylinux_2_27_x86_64.manylinux_2_28_x86_64.whl
RUN if [ $TARGETARCH == "arm64" ] && curl -o mf.whl -L https://sglang-ascend.obs.cn-east-3.myhuaweicloud.com/sglang/mf_adapter-1.0.0-cp311-cp311-linux_aarch64.whl
RUN if [ $TARGETARCH == "arm64" ] && curl -o pta.whl -L https://gitee.com/ascend/pytorch/releases/download/v7.1.0.1-pytorch2.6.0/torch_npu-2.6.0.post1-cp311-cp311-manylinux_2_28_aarch64.whl
RUN if [ $TARGETARCH == "arm64" ] && curl -o triton.whl -L https://sglang-ascend.obs.cn-east-3.myhuaweicloud.com/sglang/triton_ascend-3.2.0.dev20250729-cp311-cp311-manylinux_2_27_aarch64.manylinux_2_28_aarch64.whl
